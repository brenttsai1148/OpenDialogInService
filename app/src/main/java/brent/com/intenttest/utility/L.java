...
public final class L {
	public final static String TAG = "LinphoneSample";
	...
	private static String packageName = "com.twm.pt.linphonesample";
	private static String appName = "LinphoneSample";
	private static String logFileName = "LinphoneSample.txt";
